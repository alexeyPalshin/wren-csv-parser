...
ALTER TABLE tblProductData ADD strProductCost varchar(10) NULL;
ALTER TABLE tblProductData ADD strProductStock varchar(10) NULL;
ALTER TABLE tblProductData
  MODIFY COLUMN strProductStock varchar(10) AFTER strProductCode,
  MODIFY COLUMN strProductCost varchar(10) AFTER strProductStock;
